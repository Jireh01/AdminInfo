informe<-{
  fluidRow(
    ...
    div(
      column(12,align="Left",br(),h3("Tema Coyuntural"),style="text-align: justify;",
             h4("En el Peru, la educacion es algo muy importante y que lamentablemente, conseguir una de buena calidad es dificil. 
               ...
               En especial porque el congreso mismo que vaco al presidente Vizcarra, aprobo una ley de reforma universitaria en donde le daba
               una segunda oportunidad a las universidades que justamente el primer ministro Antero, del gabinete del presidente Merino, tenia
               contactos, e incluso representaba en su estudio legal a algunas de ellas.
               ...
               El segundo dataset fue sobre los programas o cursos que las universidades brindaban, asi como postgrado, y el nivel con el
      ...
      column(12,align="Left",br(),h3("Descripcion del Proyecto"),style="text-align: justify;",
      ...
      column(12, align="Left", br(),h3("Procedimiento"),style="text-align: justify;",
             ...
             descargado fuentes de tipo csv (que no separadas con coma sino con plecas) y excel(xls). Una vez realizado esto, se han preprocesado los valores, se han quitado
                tildes, se han removido los espacios en blanco y reemplazados con N/A, se han uniformizado los nombres de las variables, se han removido las columnas innecesarias
                y se ha convertido los string a enteros. Por ultimo, se han guardado los 3 Dataset ya preprocesados en un formato csv, 
                esto debido a que deseamos que sea homogeneo.
                
                Una vez obtenido estos nuevos csv se ha pasado a la exploracion y transformacion de los datasets. Como se menciono en la introduccion, lo que se
                busca es uniformar los 3 dataset y formar uno con las licencias actualizadas, por lo que se ha agarrado las 3 dataset y se ha realziado un Inner_join entre todos ellos
                para que al final nos quedemos con las columnas deseadas como nombre, numero de programas y cantidad de carnets.
                Una vez realizado esto, se ha creado el ultimo dataset con los licenciamientos actualizados.
                ...
                sacado percentiles, media, maximo y minimo. En otras hemos usado el select y filter para un mejor manejo de datos. Todas las consultas de datos que se han realizado
                ...
                mas complicado. En la parte de graficos, se ha usado diferentes herramientas y diagramas para poder representar algunas consultas y problematicas de los Datasets.
                Entre estos diagramas utilizados estan los de barra, dispersion, caja y pie. Estos graficos, al igual que las consultas, van en aumento de complejidad.
                En la parte de los modelados, como se ha mencionado en la presentacion, nuestro dataset no era apto para realizar estos modelados. Por ello, se consulto
                al docente si se podia realizar esto con un dataset externo, a lo que el profesor afirmo. El primer modelo realizado fue la regresion lineal, a esta se 
                utilizo la funcion lm, que esta integrada dentro de R. Esta nos ha permitido dibujar la linea de regresion en un eje x vs y. Despues, se vio la regresion
                polinomial, esta regresion no se puede graficar debido a que al ser tres variables se tenia que dibujar en 3D y al ser 4, en 4D. En el proyecto, se ha utilizado
                ...
                Para este se ha utilizado la funcion incorporada de R, donde se ha utilizado el 70% de un dataset para entrenar y el otro 30% para testear.
                Una vez hecho esto se realiza una funcion para calcular el accuracy(precision) del algoritmo. El siguiente algoritmo es Kmeans, para este se ha utilizado
                dos variables cualquiera, x, y del dataframe vinos. Utilizaremos la funcion incorporada de R, en esta funcion se ha pasado los
                Dataframe y los k. Luego, simplemente, los ploteamos(graficamos) con la funcion kmeans. El algoritmo PCA se ha realizado el mismo procedimiento que realizo
                ...
                como factor. Una vez hecho esto se utiliza la funcion SVM de R, en la cual se le tiene que pasar y con la formula que se incorporara para resolver 
                ...
                aceptar cualquier largo maximo y minimo, asi no tiene que se especificado manualmente cada vez que se cambie el x. Para mas informacion
      ...
      column(12, align="Left", br(),h3("Conclusiones"),style="text-align: justify;",
      ...
      column(12, align="Left", br(),h3("Agradecimientos"),style="text-align: justify;",
             h4("Agradecemos al profesor WALTER CUEVA por habernos guiado en todo este trayecto del ciclo que, a pesar de tropezones que se
                ha podido dar en todo este tiempo, ha sabido tratar a sus alumnos con sabiduria e inteligencia.
                Gracias profesor.
                Por favor, siga siendo tan bueno con nosotros como lo ha sido el resto del ciclo, Gracias."))
